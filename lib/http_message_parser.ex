...
defmodule HttpMessageParser do
  ...
  alias HttpMessageParser.Parser
  ...
  defdelegate parse_request(message), to: Parser
  @spec parse_response(binary) :: {:ok, Response.t()} | {:error, atom | {atom, binary}}
  defdelegate parse_response(message), to: Parser
end
