...
defmodule HttpMessageParser do
  ...
  ```
  """
  @spec parse_request(binary) :: {:error, atom | {atom, binary}} | {:ok, HttpMessageParser.Request}
  defdelegate parse_request(message), to: HttpMessageParser.Parser
  @spec parse_response(binary) :: {:error, atom | {atom, binary}} | {:ok, HttpMessageParser.Response}
